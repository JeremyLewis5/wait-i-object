...
myCodeImmersivesObj.cumulativeScore = 50 + 3;
//console.log(myCodeImmersivesObj)
...
user.address = ['123 Main St', 'Noneya', 'State']
//console.log(user)
//console.log(myCodeImmersivesObj)
...
const newOject = {
 string: 'strings!', number: 123, boolean: true, array: ['this', 'is', 'an', 'array'] 
